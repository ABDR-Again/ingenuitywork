...
class WhatsappWidget extends HTMLElement {
  connectedCallback() {
    ...
    this.innerHTML = `
      <a href="https://wa.me/923114717158" target="_blank" rel="noopener noreferrer" class="whatsapp-widget-btn" aria-label="Chat with us on WhatsApp">
        <svg class="whatsapp-widget-icon" viewBox="0 0 24 24">
